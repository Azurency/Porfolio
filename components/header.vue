<template>
    <header class="index-header">
        ...
        <div class="index-header__pattern">
            <svg xmlns="http://www.w3.org/2000/svg" width="514" height="523" viewBox="0 0 514 523">
                <defs>
                ...
                <g fill="none" fill-rule="evenodd" transform="translate(0 -14)">
                    <path fill="#CAE8F0" d="M558.049183,474 C579.062337,154.231224 574.226932,-3.62554671 543.542969,0.4296875 C493.769531,7.0078125 451,107.753906 304.804688,207.707031 C158.609375,307.660156 -64.4882812,-16.3359375 17.8710938,170.304687 C100.230469,356.945312 50.859375,48.515625 185.796875,62.6835937 C317.556244,76.5178698 59.1817127,295.670234 180.984375,321.410156 C211.036016,327.760813 235.394531,385.226562 129.476563,431.394531 C23.5585938,477.5625 10.0351563,325.445312 140,388.078125 C189.826375,412.090511 256.460905,440.731136 339.90359,474 L558.049183,474 Z M552.861893,548.999974 C552.709676,551.10331 552.556492,553.212694 552.402344,555.328125 C546.672628,553.205791 540.989976,551.096416 535.354385,549 L552.861892,549 L552.861893,548.999974 Z" />
                    <circle cx="425.5" cy="238.5" r="138.922" fill="#FFAC3F" />
                    <circle cx="283.5" cy="198.5" r="70.5" fill="url(#a)" opacity=".45" />
                    <polygon stroke="url(#b)" stroke-width="10" points="362 393.538 423.946 368 405.55 431.396" opacity=".6" stroke-linecap="round" />
                    <path stroke="url(#c)" stroke-width="10" d="M344.152181,43 C326.864297,59.8272991 331.655728,68.7902154 358.526472,69.8887489 C398.83259,71.536549 348.388112,106.549381 383.887096,110.065078 C419.386079,113.580775 419.547037,132.641499 412.080178,145" stroke-linecap="round" />
                    <polygon fill="url(#d)" points="430 472.078 494.092 438 528.17 502.092 464.078 536.17" opacity=".8" />
                    <circle cx="237.5" cy="442.5" r="49.5" fill="#82A6C2" opacity=".5" />
                    <circle cx="243.5" cy="436.5" r="49.5" fill="#50CDF7" opacity=".302" />
                </g>
            </svg>
