        ...
        <div class="index-header__container">
            ...
            <div class="index-header__info">
                ...
                <p class="index-header__text" style="visibility: hidden;" v-scroll-reveal="{ delay: 450 }">
                    ...
                    <b>designer</b> passionné habitant actuellement à Paris en France. Je crée des applications web et mobiles sur mesure, intuitives, utiles et modernes.
                </p>
            </div>
        </div>
        <div class="index-header__pattern">
            <svg xmlns="http://www.w3.org/2000/svg" width="514" height="553" viewBox="0 0 514 553">
                ...
                <g fill="none" fill-rule="evenodd" transform="translate(0 -14)">
                    ...
                    <g class="svg-anim-container"><circle title="Si vous voulez savoir, j'ai 24 ans" @mouseover="hoverShape" @mouseleave="leaveShape" class="svg-anim js-floating-shape" data-duration="15s"  data-start="100px" data-delay="450" cx="425.5" cy="238.5" r="138.922" fill="#FFAC3F" /></g>
                    ...
                    <g class="svg-anim-container"><circle title="J'ai fini mes études en 2018" @mouseover="hoverShape" @mouseleave="leaveShape" class="svg-anim js-floating-shape" data-duration="15s" data-delay="500"  cx="243.5" cy="436.5" r="49.5" fill="#50CDF7" data-opacity=".3"  /></g>
                </g>
            </svg>
